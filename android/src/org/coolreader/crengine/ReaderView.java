...
//			});
    ...
    private void showDialogReaderMenu()
    {
        final DialogReaderMenu.IMenuHandler menu_handler = new DialogReaderMenu.IMenuHandler()
        {
            ...
            public void showTOC()
            {
                ReaderView.this.showDirectoryMenu(DirectoryTab.toc);
            }
            ...
            {
                ReaderView.this.showDirectoryMenu(DirectoryTab.bookmark);
            }
            ...
            {
                ReaderView.this.showDirectoryMenu(DirectoryTab.annotation);
            }
        };
    ...
    private void showDirectoryMenu(DirectoryTab tab)
    {
